  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-foreground">AI Suggestions</h1>
          <p className="text-sm md:text-base text-muted-foreground">AI-powered insights and recommendations for your Facebook strategy</p>
        </div>
        <Button 
